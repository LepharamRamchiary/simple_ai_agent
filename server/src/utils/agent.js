...
const analyzeTicket = async (ticket) => {
  ...
  const response =
    ...
    Analyze the following ticket and peovide a JSON object with:
    - summary: A short 1-2 sentence summary of the issue.
    - priority: One of "low", "medium", "high", or "critical".
    - helpfulNotes: A detailed technical explanation that a moderator can use to solve this issue. Include useful external links or resources if possible.
    - requiredSkills: An array of relevant skills required to solve this issue(e.g., ["React", "Node.js", "AWS", "JavaScript"]).
    ...
    "requiredSkills": ["React", "Node.js", "AWS", "JavaScript"]
    }
